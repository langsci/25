...
\textit{\LARGE {Second revised and extended edition} } }
\renewcommand{\lsImpressumCitationText}{%
Stefan Müller. 2018. \textit{Grammatical theory: From transformational grammar to
constraint-based approaches. Second revised and extended edition}. (Textbooks in Language Sciences~1). Berlin: Language Science Press.
}
