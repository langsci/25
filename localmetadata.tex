...
\textit{\LARGE {Fourth revised and extended edition} } }
\renewcommand{\lsImpressumCitationText}{%
Stefan Müller. \lsYear. \textit{Grammatical theory: From transformational grammar to
constraint-based approaches. Fourth revised and extended edition}. (Textbooks in Language Sciences~1). Berlin: Language Science Press.
}
...
\renewcommand{\lsISBNhardcover}{978-3-96110-220-4} % 3rd ed., one-volume ISBN 	
\renewcommand{\lsISBNsoftcover}{978-3-96110-221-1} % 3rd ed., one-volume ISBN
\renewcommand{\lsBookDOI}{10.5281/zenodo.3364215} % 3rd edition
...
\renewcommand{\lsURL}{http://langsci-press.org/catalog/book/255} % contact the coordinator for the right number
