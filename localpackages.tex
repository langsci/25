...
% This probably needs to be in localfonts as well. 
% I can't test because I don't have the font. (SZ)
% 
% Haitao Liu
% \usepackage{xeCJK}
...
\tikzset{external/prefix={grammatical-theory.for.dir/}}
\forestset{external/master=grammatical-theory}

\usepackage{./langsci/styles/forest-externalizetikz}
