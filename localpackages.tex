...
% Add this style when using forest v 1.05
% taken from the definition of triangle, triangle does no longer exist in forest 2.0, so we call
% everything roof now.
\forestset{
  roof/.style={edge path={%
      \noexpand\path[\forestoption{edge}]%
      (\forestove{name}.north
      east)--(\forestOve{\forestove{@parent}}{name}.south)--(\forestove{name}.north
      west)--(\forestove{name}.north east)\forestoption{edge label};}},
}
