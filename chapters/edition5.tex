...
%
% 14.10.2022 added ref to \citet[\page 172]{BG2014a-u} for IPless analysis of German
%
% irgendwann in 3-gb Professor -> Professorin, weil zu lang dann Kino in essen gehen geändert.
%
% Kapitel 3-minimalism mehr zu Bindung
%
% 26.11.2022 
% hyphenation in footnote 24 HPSG/""Construction
%
%
% 02.01.2023 We used -> I used
%
...
been \type{woman} rather than \type{female person}. I also changed the values of \textsc{father} and \textsc{mother}
into \type{man} and \type{woman}. The top-most type in Figure~\ref{fig-electric-appliance} has to be
\type{electric device} rather than \type{electrical appliance}, since this is the name used in the
text.
%
