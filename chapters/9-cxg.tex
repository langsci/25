...
in (\mex{1}), \emph{he sneezed} could be parsed, but \emph{the foam} and \emph{off the cappuccino} would be unintegrated.
\ea
...
current communicative setting.} \citep[\page 256]{vanTrijp2014a}
