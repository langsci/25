...
assume that there is an object in every sentence (Stabler\ia{Stabler, Edward P.} quoted in
...
one wishes to class as an utterance from Utterance.\footnote{%
	...
	also \emph{the man} or \emph{now}. See also \citew[Section~8.1.4]{GSag2000a-u} for a unary
        ...
        the utterance context. See \citew{NK2019a} for further details and references on \isi{ellipsis} in \hpsg.
}
