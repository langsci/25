...
\citew{Everett2009a-u,Everett2012a}). 
...
Using the lexical entries in (\mex{1}), it is only possible to analyze the two sentences in (\mex{2}) and certainly not to build recursive structures.
