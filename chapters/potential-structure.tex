...
arguments. (\mex{1}) provides the example from Hindi\il{Hindi}\il{Urdu} discussed by \citet*{ARP2019a}.
...
In what follows I compare the analysis of \citet{ARP2019a} in the framework of Lexicalized TAG with
...
\citet{ARP2019a} assume that the structures for the examples in (\mex{0}) are composed of elementary
...
Korean \citep{Chung98a-u}, and Persian\il{Persian} \citep{MuellerPersian}. See \citew{GS2019a} for
