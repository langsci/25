...
arguments. (\mex{1}) provides the example from Hindi\il{Hindi}\il{Urdu} discussed by \citet*{ARP2018a}.
...
\gll pustak=kii tareef hu-ii\\
     book.\textsc{f}.\textsc{sg}=\textsc{gen} praise.\textsc{f} be.Part-\textsc{perf}.\textsc{f}.\textsc{sg}/be.\textsc{pres}\\
...
In what follows I compare the analysis of \citet{ARP2018a} in the framework of Lexicalized TAG with
