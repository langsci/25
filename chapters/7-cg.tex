...
\citep*{YK90a-u,Carpenter1994a-u,BvN94a-u,Llore1995a-u,Koenig99a-u,Moot2002a-u,WB2003a-u,BCPW2007a,Morrill2012a,Morrill2017a-u}. An
...
The question as to how to analyze the pair of sentences in (\mex{1}) still remains unanswered.\footnote{%
	Thanks to Roland Sch\"{a}fer\ia{Roland Sch{\"a}fer} (p.\,m., 2009) for pointing out these data to me.
}
\eal
...
\emph{gave} has the category ((s\bs np)/pp)/np, that is, the verb must first combine with an NP (\emph{the
  ...
  Baldridge\ia{Jason Baldridge} (p.\,M.\ 2010) suggests using regular expressions in a general lexical rule for passive.%
 }
