...
their coach and set out for the port of Calais.\footnote{\url{http://www.amazon.com/review/R3IG4M3Q6YYNFT}, 20.02.2018}
...
the argument cannot be ommitted without changing the meaning. Sebastian Nordhoff\aimention{Sebastian Nordhoff}
...
and \argthree: \argtwo can be realized as \subj or as \obj. In the active case \argone will be the \subj and because of function argument bi-uniqueness \citep[\page 334]{BATW2015a} no other element can be the \subj and hence \argtwo has to
...
\footnotetext{
  ...
  \url{http://www.golyr.de/oliver-kalkofe/songtext-gedicht-fuer-den-frieden-417329.html}. 20.02.2018.
} 
