...
be:\todostefan{Is it \objtheta or \lfgobj? If it could be \lfgobj, the verb would have to be marked
...
scientific work. Figure~\vref{fig-inheritance-ZL} shows a hierarchy that was suggested by \citet[\page 97]{ZL2013a-u} for
German for sentences with the verbs \emph{lachen} `laugh', \emph{weinen} `cry', \emph{drücken}
`push', \emph{mögen} `like'.
\begin{figure}
\oneline{%
\begin{forest}
for tree={draw,          % to get the boxes
