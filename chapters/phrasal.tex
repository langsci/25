...
and \argthree: \argtwo can be realized as \lfgsubj or as \lfgobj. In the active case \argone will be the \subj and because of function argument bi-uniqueness \citep[\page 334]{BATW2015a} no other element can be the \lfgsubj and hence \argtwo has to
...
[CP
	...
	[vP
		[PP$_2$
			[in den Müll\\in the trash,tier=word,roof]]
		[v$'$
			[VP
				[DP$_1$
