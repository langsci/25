...
for instance the conversion of the verb \emph{play} into the noun \emph{play} (see Figure~\ref{fig-transfer-play}). 
\begin{figure}
\hfill
\begin{forest}
      [O
...
\caption{\label{fig-wg-small-children-are-playing-outside}Analysis of \emph{Small children were
    playing outside.} according to \citet[\page 105]{Hudson2017a}}
\end{figure}%
\begin{figure}
\begin{forest}
  wg
...
\caption{\label{fig-wg-small-children-are-playing-outside-abbreviated}Abbreviated analysis of \emph{Small children were
    playing outside.} according to \citet[\page 105]{Hudson2017a}}
\end{figure}%
What is shown in the first\pagebreak{} diagram is that a combination of two nodes results in a new
...
The simplicity claim is repeatedly made in Timothy Osborne's work (for example in \citealp[\page
...
that additional structure is needed in order to account for these phenomena. Somewhat iroically,
Osborne worked out analyses in his reply that introduced a new concept (the Colocant\is{Colocant})
...
for purely selection"=based grammars.\pagebreak
