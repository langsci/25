...
fewer transformations has been proven wrong \parencites[\page
320--328]{FBG74a-u}[Chapter~15.1]{MuellerGT-Eng5}. The T-model with its autonomous components of 
...
%
  ...
  % lab. You have soil and water. The water runs in little rivers, carves valley into the soil. The
...
So \citet{FoxKatzir2024a} argue that the theory, if it existed in LLMs, would be wrong. I argue that
...
Maybe the last sentence needs a bit of qualification. \citet{Piantadosi2024a} claims that Chomsky's
...
language and worked like a switch \parencites{Rizzi86a}[\page 8]{Chomsky2000a-u}, but none of the suggested correlations held 
up 
\iftoggle{long}{%
...
certain bounding nodes within nonlocal dependencies \parencites[\page 271]{Chomsky73a}[\page
40]{Chomsky86b}{Baltin81a,Baltin2006a}. First, it could be shown that subjacency does not hold in
...
\parencites[\page 20]{Abney96a}[\page 222]{Goldberg2003b}[\page 100]{Newmeyer2005a}[\page 36]{Tomasello2006a}[\page
20]{Tomasello2006c}{MuellerKernigkeit}. See \citew{MuellerKernigkeit} and the CoreGram project \citep{MuellerCoreGram}
