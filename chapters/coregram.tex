...
\eal
\ex[]{
\gll weil der Mann wahrscheinlich diese Sonate nicht oft gut gespielt hat\\
     because the man probably this sonata not often well played has\\
...
framework at all who claim that all languages are so different that we cannot even use the same
...
Persian nouns do not share all properties with English nouns.\footnote{
  ...
  \citew[Section~2]{Haspelmath2010a} for such a suggestion regarding case, \eg, Russian Dative,
