...
An example for a parameterized principle is show in (\mex{1}):
\ea
...
D"=structure. For example, there are the following ordering variants for a sentence with a ditransitive verb in (\mex{1}):
\eal
\ex 
