...
\zl
Instead of the rule NP $\to$ Det N, we will have to use rules such as those in (\mex{1}):
\ea
%\resizebox{\linewidth}{!}{
\begin{tabular}[t]{@{}l@{ }l@{~~}l}
NP\_3\_sg\_nom  & $\to$ Det\_fem\_sg\_nom\_weak & N\_fem\_sg\_nom\_weak \\
NP\_3\_sg\_nom  & $\to$ Det\_mas\_sg\_nom\_weak & N\_mas\_sg\_nom\_weak \\
NP\_3\_sg\_nom  & $\to$ Det\_neu\_sg\_nom\_weak & N\_neu\_sg\_nom\_weak \\
NP\_3\_pl\_nom  & $\to$ Det\_fem\_pl\_nom\_weak & N\_fem\_pl\_nom\_weak \\
NP\_3\_pl\_nom  & $\to$ Det\_mas\_pl\_nom\_weak & N\_mas\_pl\_nom\_weak \\
NP\_3\_pl\_nom  & $\to$ Det\_neu\_pl\_nom\_weak & N\_neu\_pl\_nom\_weak \\[2mm]
\end{tabular}

\begin{tabular}[t]{@{}l@{ }l@{~~}l}
NP\_3\_sg\_nom  & $\to$ Det\_fem\_sg\_nom\_stark & N\_fem\_sg\_nom\_stark \\
NP\_3\_sg\_nom  & $\to$ Det\_mas\_sg\_nom\_stark & N\_mas\_sg\_nom\_stark \\
NP\_3\_sg\_nom  & $\to$ Det\_neu\_sg\_nom\_stark & N\_neu\_sg\_nom\_stark \\
NP\_3\_pl\_nom  & $\to$ Det\_fem\_pl\_nom\_stark & N\_fem\_pl\_nom\_stark \\
NP\_3\_pl\_nom  & $\to$ Det\_mas\_pl\_nom\_stark & N\_mas\_pl\_nom\_stark \\
NP\_3\_pl\_nom  & $\to$ Det\_neu\_pl\_nom\_stark & N\_neu\_pl\_nom\_stark \\[2mm]
\end{tabular}
\z
...
\ea
\begin{tabular}[t]{@{}l@{ }l}
NP(3,sg,nom)  & $\to$ Det(fem,sg,nom,strong) N(fem,sg,nom,strong)\\
NP(3,sg,nom)  & $\to$ Det(mas,sg,nom,strong) N(mas,sg,nom,strong)\\
\end{tabular}
\z
...
\begin{tabular}[t]{@{}l@{ }l@{ }l}
NP({3},{Num},{Case}) & $\to$ & Det(Gen,{Num},{Case},Infl) N(Gen,{Num},{Case},Infl)\\
\end{tabular}
\z
...
\noindent
To enhance readability I will use English translations of the predicates in semantic representations
