...
\zl
\addlines[2]
Here, we are assuming \relation{sleep} to be the meaning of  \emph{schläft} `sleeps'. We use prime symbols to indicate
...
by using \relation{sleep} to represent the meaning of (\mex{0}a), since it is just another form of the verb \emph{schläft} `sleeps'.
...
\ea
$\lambda x~\relation{sleep}(x)$ \relation{max}   \todostefan{gdw. \relation{sleep}(\realtion{max})}
\z
...
\url{http://www.swi-prolog.org}, 20.02.2018.
})
...
directly without any installation.\footnote{
  \url{https://swish.swi-prolog.org/}, 20.02.2018.
}
...
\url{https://en.wikipedia.org/wiki/Definite_clause_grammar}, 20.02.2018.
}
\end{enumerate}
