...
\emph{On phases}, Chomsky refers once again to processing aspects such as computational and memory load\is{memory} (Chomsky \citeyear[\page 11, 12,
   ...
   155]{Chomsky2008a}). See also \citew[\page 440]{Marantz2005a} and \citew{Richards2010a}.
...
Furthermore, \citew{SJ93a} point out that from a purely technical point of view, synchronic processing is more costly than asynchronic processing since
