...
\ex
\begin{tabular}[t]{l}
($f$ \pred) = {\small `SNEEZE\sliste{\lfgsubj}'}\\
($f$ \lfgtense) = \lfgpast\\
($f$ \lfgsubj) = $g$\\
($g$ \pred) = {\small `DAVID'}
\end{tabular}
...
\ea
\catlexentry{sneezed}{V}{(\up\ \pred) = {\small `SNEEZE\sliste{\lfgsubj}'}\\*
                     (\up\ \lfgtense) = \lfgpast}
\z
...
\hspace*{3em}%
{\fd{\rnode{s}{\fdand{\feat{\pred}{\small `YAWN\sliste{\lfgsubj}'}
...
\catlexentry{verschlingt}{V}{(\up\ \pred) = {\small `VERSCHLINGEN\sliste{\lfgsubj, \lfgobj}'}\\*
