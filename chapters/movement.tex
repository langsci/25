...
represented formally was hardly ever made explicit in the GB literature.\todostefan{Baker, Johnson, Roberts 1989 sagen, dass der akkusativ dem pro externen Argument zugewiesen wird}
...
complete argument structure list is shared between the licenced lexical item and the stem. The first
...
\citet[Section~4.4.3]{Lenerz77} discussed the examples in (\ref{ex-passive-German-no-movment}) on
page~\pageref{ex-passive-German-no-movment} -- which are repeated here as
(\ref{ex-passive-German-no-movment-two}) for convenience:
\eal
\label{ex-passive-German-no-movment-two}
\ex 
