...
or a proliferation of T heads with respective features (see also \citealp{Borsley2006a,BM2020a}) is the only way to save this architecture. 
...
where fillers and gaps do not match and extraction without gaps. \citet{BM2020a} is another
...
\citet{BM2020a} compares Minimalism with HPSG.
