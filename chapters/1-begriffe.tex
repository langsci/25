...
We can build incredibly long and complex sentences in the ways that were demonstrated in (\mex{-1}).\footnote{%
 ...
 \citealp*[\page 67]{Chesi2015a-u}; \citealp[\page 2]{Martorell2018a}; Wikipedia entry of Biolinguistics, 2018-09-27) or that Chomsky made such claims \citep[\page 341]{Leiss2003a}. This is, however, not correct since every sentence
...
%% \footnote{%
%% Dieter Wunderlich\ia{Wunderlich, Dieter} has shown in an unpublished article that one can get by with just strong and weak inflectional classes. For details
...
\parencites{VH77a-u,Brame82a}[\page 90--92]{Hudson84a-u}{Hellan86a,Abney87a,Netter94,Netter98a}
...
Karl    & has           &                                        & claimed        & Maria to know\\\lspbottomrule
\end{tabular}
%\end{sideways}
}
