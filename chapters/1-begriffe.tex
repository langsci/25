...
\eal
\ex\label{ex-den-Romanuch-zu-lesen} 
\gll Er versucht, [den Roman zu lesen].\\
     he tries \spacebr{}the novel to read\\
\glt `He is trying to read the novel.'
\ex 
\gll Er versucht, [dem Kind den Roman zu geben].\\
     he tries \spacebr{}the child the novel to give\\
\glt `He is trying to give the child the novel.'
\zl
%
...
\noindent
It is also possible to use a pronoun to refer to constituents such as \emph{den Roman zu lesen} `the
novel to read' in \pref{ex-den-Roman-zu-lesen}, as is shown in (\mex{1}):
...
\ex 
\gll Er versucht [das].\\
     he tries    \spacebr{}that\\
\glt `He is trying to do that.'
\zl
...
Constituents such as \emph{den Roman zu lesen} in \pref{ex-den-Roman-zu-lesen} can also be elicited by questions, as (\mex{1}) 
shows:
\ea
\gll {}[Was] versucht er?\\
     \spacebr{}what tries he\\
