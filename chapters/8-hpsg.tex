...
(\citealt{Borsley87}; \citealt[Chapter~9]{ps2}). The
...
\onems
{ cat$|$arg-st \sliste{ []\ind{1}, []\ind{2}, []\ind{3}  } \\[1mm]
  cont  \ms[mrs]
           { ind & \ibox{4} event \\
...
%% \item Passive\is{passive} \citep{KC77a}
  ...
  Binding Theory\is{Binding Theory} (\citealp{Grewendorf85a}; Pollard \& Sag: \citeyear{PS92};
