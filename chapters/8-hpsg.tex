...
\item Sign Language (German, French, British, Greek)\il{sign language} \citep{SM2002a-u,MS2004a-u,SG2010a-u},
...
\item Portugese\il{Portugese} \citep{BC2008a-u,BC2008b-single-quotes,CB2010a-u},
...
\citet*{BMS2001a} cite\label{Seite-Irishe-Komplementierer}  Irish\il{Irish},
...
does not form part of theoretical explanations. In implementations, macros\is{macro} (abbreviations) are often used for co"=occuring feature"=value pairs
