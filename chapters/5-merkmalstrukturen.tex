...
(\mex{1}) shows the feature description for the type \textit{woman}. The feature description for \textit{man} would be analogous.
\ea
\ms[woman]{
firstname    & firstname\\
lastname & lastname\\
...
%% \end{forest}
\begin{tabular}{cccc}
\multicolumn{4}{c}{\mynode{ed}{\type{electric device}}}\\[6ex]
