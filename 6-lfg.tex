...
Kohl92a-u,KM92a-u,% CHARON Generator
WA86a-u,%
...
\item French\il{French} \citep*{Zweigenbaum91a-u,Frank96b-u,FZ2002a-u,BDFK99a-u,CK2001a-u,BSL2005a-u,SdA2015a-u},
% Knueppel2001a-u
%
%
...
\item Portugiese\il{Portugiese} \citep{Alencar2004a-u,Alencar2013a-u},
...
\ex \lfgms{ pred & `DEVOUR\sliste{\subj, \obj}'\\
...
\noindent
Every lexical item contributes a \textsc{pred}\isfeat{pred} feature with a corresponding value.
...
In the structure in (\mex{0}b), the \subj{} and \obj{} in the list following \emph{devour} are identical to the values of \subj{} and \obj{} in the structure. For reasons of presentation, this will not be explicitly indicated in this structure and following structures.
}
...
\ea
\label{Beispiel-LFG-Beschraenkungen}
($f$ \subj) = $g$
\z
...
\ea
$f$: \lfgms{ pred  & `SNEEZE\arglist{\subj}'\\
             tense & PAST\\
...
\end{tabular}
\hspace*{4em}
\rnode{d}{\raisebox{-2em}{\fd{\fdand{\feat{\pred}{\small `SNEEZE\arglist{\subj}'}
                    \feat{\tense}{\small PAST}}}}}
\ncline{v1}{v}\ncline{v}{sneezed}%
\ltor{a}{d}
\Aput*{$\phi$}
\ltor{b}{d}
...
\hspace*{4em}%
{\rnode{o}{\raisebox{-2em}{\fd{\fdand{\feat{\pred}{\small `YAWN\arglist{\subj}'}
                    \feat{\tense}{\small PRES}
           \feat{\subj}{\fdand{\feat{\pred}{\small `DAVID'}}}}}}}}
\ltor{a}{o}
\ltor{b}{o}
\ltor[10]{c}{o}
\ltor{d}{o}
...
\ex[]{
\lfgms{ pred & `DEVOUR\sliste{\subj,\obj}'\\
         subj & \lfgms{ pred &  `DAVID' \\
                   }\\
       }
}
...
\ex[]{
\lfgms{ pred & `DEVOUR\sliste{\subj,\obj}'\\
         subj & [ \textsc{pred}  `DAVID' ] \\
         obj  & \lfgms{ spec &  A\\
                     pred & `SANDWICH'\\
                   }\\
         comp & \lfgms{ pred & `SLEEP\sliste{\subj}'\\
...
Both of those constraints taken together correspond to the Theta Criterion\is{Theta Criterion} in \gbt (see
...
\hspace*{3em}%
\rnode{d}{\fd{\fdand{\feat{\obj}{\rnode{e}{[\ ]}}}}}
\ltor{a}{d}
\ltor[20]{b}{d}
\ltor{c}[190]{e}
\z
In the equation (\up\ \obj) = \down{},  the arrows `\up' and `\down' correspond to feature structures. `\up' and
`\down' stand for the $f$ and $g$ in equations such as (\ref{Beispiel-LFG-Beschraenkungen}).

(\mex{1}) is an example with an intransitive verb
and the corresponding visualization is in (\mex{2}):

\ea
\catlexentry{sneezed}{V}{(\up\ \pred) = {\small `SNEEZE\arglist{\subj}'}\\*
                     (\up\ \tense) = \small PAST}
\z
...
\tree{V}{\le{sneezed}}
\hspace*{4em}
\rnode{d}{\mbox{\fd{\fdand{\feat{\pred}{\small `SNEEZE\arglist{\subj}'}
                    \feat{\tense}{\small PAST}}}}}
\ltor{top}{d}
\z
...
The syntactic structure for the sentence in (\mex{1}a) together with its semantic representation is given in (\mex{1}b):
...
\ea
\mt{\lambda x. \relation{yawn}(x)}{(\up\ \subj)_\sigma\ \linimp\ \ups}
\z
...
\eanoraggedright
 ~\\[-\baselineskip]
\fd{$y:$\rnode{s}{\fdand{\feat{\pred}{\small `YAWN\arglist{\subj}'}
           \feat{\subj}{$d:$\fdand{\feat{\pred}{\small `DAVID'}}}}}}~\\[1em]
{$\begin{array}[t]{lr@{\;:\;}l}
...
which syntactic structure is comprised (\emph{lexical integrity}\is{lexical integrity}\footnote{
 See \citew[\page 84]{Anderson92a-u}
...
HPSG, CxG, DG and TAG. As far as I know, this kind of analysis has never been proposed. 
...
In later work, the assignment of grammatical functions was taken over by Lexical Mapping Theory\is{Lexical Mapping Theory (LMT)|(}\is{linking|(}
...
\ex Subject"=Mapping"=Principle:\is{principle!Subject"=Mapping} The most prominent role marked with [$-$o] is mapped to \subj if it is initial in the a"=structure.
...
\zl
For the argument structure in (\mex{-1}), the principle in (\mex{0}a) ensures that the agent x receives the grammatical function \subj. (\mex{0}b) adds an o"=feature with the value `+'
...
a-structure & \emph{schlagen} `beat' & $\langle$ x & y~~ $\rangle$\\
           &          & \hspaceThis{$\langle$}[$-$o]    & [$-$r] \\\cline{3-4}
           &          & \hspaceThis{$\langle$}$\varnothing$       & \subj
\end{tabular}
\z
...
a-structure & \emph{helfen} `help' & $\langle$ x & y~~ $\rangle$\\
           ...
           &          & \hspaceThis{$\langle$}\subj       & \objtheta
\end{tabular}
\z
...
\centerline{%
\begin{tabular}{@{}ccc}
\multicolumn{2}{c}{\rnode{cp}{CP}}\\[2ex]
\multicolumn{2}{c}{\rnode{c1_oben}{\up~=~\down}}\\
\multicolumn{2}{c}{\rnode{c1}{C$'$}}\\[2ex]
\rnode{c_oben}{\up~=~\down} & \multicolumn{2}{c}{\rnode{vp_oben}{\up~=~\down}}\\
\rnode{c}{C}              & \multicolumn{2}{c}{\rnode{vp}{VP}}\\[2ex]
                         & \rnode{npnom_oben}{(\upsp \textsc{subj}) = \down} & \rnode{npacc_oben}{(\upsp \textsc{obj}) = \down}\\
                         & \rnode{npnom}{NP} & \rnode{npacc}{NP}\\[3ex]
\rnode{ver}{Verschlingt}  & \rnode{David}{David} & ei\rnode{s}{n Sandwic}h?\\
...
\raisebox{3em}{\rnode{alles}{\lfgms{ pred & `VERSCHLINGEN\sliste{\subj,\obj}'\\
         ...
         tense & {\small PRESENT}\\
         obj  & \rnode{fsand}{\lfgms{ pred & `SANDWICH'\\
                   }}\\
       }}}
% to do \anodecurve[r]{vp}[l]{alles}{3em}%
\ltor{vp}{alles}
% to do \anodecurve[r]{c1}[l]{alles}{3em}%
\ltor{c1}{alles}
% to do \anodecurve[r]{c}[l]{alles}{6em}%
\ltor{c}{alles}
% to do \anodecurve[r]{npnom}[l]{fdavid}{3em}%
\ltor{rpnom}{fdavid}
% to do \anodecurve[r]{npacc}[l]{fsand}{3em}%
\ltor{npacc}{fsand}
}
...
\is{head domain!extended|)}\is{verb final}
...
The four cases in German can be represented using two binary features ({\small GOV}, {\small OBL}) \citep[\page 22]{Berman96a-u}. Nominative corresponds to {\small GOV}$-$ and
  ...
  I will omit this feature decomposition and insert the case values directly.
	...
	Alternative analyses derive the grammatical function of an NP from its case (\citew[\page
  37]{Berman2003a} for German; \citew[\page 187, \page 201]{Bresnan2001a} for German and Russian).
\ea
...
\catlexentry{verschlingt}{V}{(\up\ \pred) = {\small `VERSCHLINGEN\arglist{\subj, \obj}'}\\*
                     (\up\ \subj{} {\small AGR CAS}) = NOM\\*
                     (\up\ \obj{} {\small AGR CAS}) = ACC\\*
                     (\up\ \tense) = \small PRESENT}
\z
...
\centerline{%
\begin{tabular}{@{}ccc}
\multicolumn{2}{c}{\rnode{vp1}{VP}}\\[3ex]
%
\rnode{npnom_oben}{(\upsp \textsc{subj}) = \down} & \multicolumn{2}{c}{\rnode{vp2}{VP}}\\
\rnode{npnom}{NP} \\[3ex]
%
                                          & \rnode{npacc_oben}{(\upsp \textsc{obj}) = \down}  & \rnode{vp3}{VP}\\
                                          & \rnode{npacc}{NP}\\[3ex]
%
                                          &  & \rnode{v}{V}\\[3ex]
%
\rnode{David}{David}                       & d\rnode{s}{en Apf}el                   & \rnode{ver}{verschlingt} \\
David                                     & the apple                               & devours
\end{tabular}%
\ncline{vp1}{npnom_oben}\ncline{vp1}{vp2}%
\ncline{vp2}{npacc_oben}\ncline{vp2}{vp3}%
\ncline{vp3}{v}%
\ncline{v}{ver}\ncline{npnom}{David}\ncline{npacc}{s}%
\hspace{2em}\raisebox{3em}{\rnode{alles}{\lfgms{ pred & `VERSCHLINGEN\sliste{\subj,\obj}'\\
         subj & \rnode{fdavid}{\lfgms{ agr cas & NOM \\
                                      pred &  `DAVID' \\
                   }}\\
         tense & {\small PRESENT}\\
         obj  & \rnode{fsand}{\lfgms{ agr cas & ACC \\
                                     pred & `APFEL'\\
                   }}\\
       }}}
% to do \anodecurve[r]{vp1}[l]{alles}{5em}[2em]%
\ltor{vp1}{alles}
% to do \anodecurve[r]{vp2}[l]{alles}{3em}%
\ltor{vp2}{alles}
% to do \anodecurve[r]{vp3}[l]{alles}{6em}%
\ltor{vp3}{alles}
% to do \anodecurve[r]{v}[l]{alles}{6em}%
\ltor{v}{alles}
% to do \anodecurve[r][-15]{npnom}[l][45]{fdavid}{5em}%
\ltor{npnom}{fdavid}
% to do \anodecurve[r][-45]{npacc}[l][45]{fsand}{3em}%
\ltor{npacc}{fsand}
}
...
\multicolumn{2}{c}{\rnode{vp1}{VP}}\\[3ex]
%
\rnode{npacc_oben}{(\upsp \textsc{obj}) = \down} & \multicolumn{2}{c}{\rnode{vp2}{VP}}\\
\rnode{npacc}{NP}\\[3ex]
%
 & \rnode{npnom_oben}{(\upsp \textsc{subj}) = \down}    & \rnode{vp3}{VP}\\
                         & \rnode{npnom}{NP}  \\[3ex]
%
                                          &                                             & \rnode{v}{V}\\[3ex]   
%
d\rnode{s}{en Apf}el                       & \rnode{David}{David}                      & \rnode{ver}{verschlingt} \\
the apple                                 & David                                       & devours\\
\end{tabular}%
\ncline{vp1}{npacc_oben}\ncline{vp1}{vp2}%
\ncline{vp2}{npnom_oben}\ncline{vp2}{vp3}%
\ncline{vp3}{v}%
\ncline{v}{ver}\ncline{npnom}{David}\ncline{npacc}{s}%
\hspace{2em}\raisebox{3em}{\rnode{alles}{\lfgms{ pred & `VERSCHLINGEN\sliste{\subj,\obj}'\\
         subj & \rnode{fdavid}{\lfgms{ agr cas & NOM \\
...
% to do \anodecurve[r]{vp3}[l]{alles}{6em}%
\ltor{vp3}{alles}
%% to do \anodecurve[r]{zp1}[l]{alles}{3em}%
\ltor{zp1}{alles}
%% to do \anodecurve[r]{zp2}[l]{alles}{3em}%
\ltor{zp2}{alles}
% to do \anodecurve[r]{v}[l]{alles}{6em}%
\ltor{v}{alles}
% to do \anodecurve[r][0]{npnom}[l][45]{fdavid}{5em}%
\ltor{npnom}{fdavid}
% to do \anodecurve[r][0]{npacc}[l][45]{fsand}{3em}%
\ltor{npacc}{fsand}
}
...
\z
For one, it has an argument function which is normally realized in a different position (the \obj function of \emph{saw} in the above example) and additionally it has a discourse function:
...
\ea
\lfgms{ pred & `THINK\sliste{ \subj, comp }' \\
        topic & \rnode{topic}{\lfgms{ pred & `CHRIS' \\
                                   }}\\[4mm]
        subj & \lfgms{ pred & `pro'\\
                     }\\
        comp & \lfgms{ pred & `SEE\sliste{ \subj, \obj }'\\
                       subj & \lfgms{ pred & `DAVID' \\
                                    }\\
                       obj  & \rnode{obj}{}\\
                     }\\
...
\ex Chris, we saw.
\ex 
\lfgms{ pred & `SEE\sliste{ \subj, \obj }' \\
        topic & \rnode{topic}{\lfgms{ pred & `CHRIS' \\
                                   }}\\[4mm]
        subj & \lfgms{ pred & `pro'\\
                     }\\
...
\lfgms{ pred & `THINK\sliste{ \subj, comp }' \\
        ...
        comp & \lfgms{ pred & `CLAIM\sliste{ \subj, comp }\\
...
(\mex{1}):\footnote{
  ...
  ensure that both occurances of \textsc{df} refer to the same discourse function.
}
\ea
\begin{tabular}[t]{@{}ccc@{~=~}lc@{}}
...
Theta Criterion\is{Theta Theory@$\theta$-Theory} and Case Theory\is{case} in GB. LFG can explicitly differentiate between subjects and non"=subjects. In GB, on the other hand,
...
German in LFG are \citew{Berman96a-u,Berman2003a}.  
