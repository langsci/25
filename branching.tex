...
{}[Mummy [must [leave now]]]
\z
The relevant tests showing this included elliptical constructions\is{ellipsis}, that is, the fact that it is possible to
...
In this book, such restrictions were not discussed, but we have seen some theories model binding relations\is{Binding Theory}
