...
In Dependency Grammar, Mel'čuk (\citeyear[\page 303]{Melcuk88a-u}; \citeyear[\page
  219]{Melcuk2003a-u}),
...
%\todostefan{O: Starosta 1988:253, Eroms 2000:472, Mel’čuk 2003:219, Hudson (2007:172-182, 2010)}
...
\ex \ldots
\zl
Since all the elements on the right"=hand side of the rule are optional, (\mex{-1}) also stands for (\mex{1}):
\ea
V$'$ $\to$ $\epsilon$
\z
...
CLLS is an underspecification formalism\is{underspecification}, that is, no logical formula are given but instead expressions that
...
-- repeated here as (\mex{1}):\todostefan{skopus hinzufuegen?}
\ea
